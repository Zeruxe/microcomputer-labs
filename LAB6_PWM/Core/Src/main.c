...
const float half_arr = 5000; /* set to (ARR+1) / 2.0f !!! */
...
int main(void)
{
  ...
  while (1)
  {
	  if (runcode) {
		  ...
		  rf = (rf + 1.0) * half_arr * 1;	 //
		  gf = (gf + 1.0) * half_arr * 0.5;  //Grön lyser starkast för samma ljusintensitet
		  bf = (bf + 1.0) * half_arr * 0.8;
